...
// This is a 100% exact Go translation of Python's experian parser
package experian
...
// New creates a new experian parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("experian"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python experian.py
