...
// This is a 100% exact Go translation of Python's heficed parser
package heficed
...
// New creates a new heficed parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("heficed"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python heficed.py
