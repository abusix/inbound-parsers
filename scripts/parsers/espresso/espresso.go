...
// This is a 100% exact Go translation of Python's espresso parser
package espresso
...
// New creates a new espresso parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("espresso"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python espresso.py
