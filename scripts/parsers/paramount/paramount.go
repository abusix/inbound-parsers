...
// This is a 100% exact Go translation of Python's paramount parser
package paramount
...
// New creates a new paramount parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("paramount"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python paramount.py
