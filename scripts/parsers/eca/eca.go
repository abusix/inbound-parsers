...
// This is a 100% exact Go translation of Python's eca parser
package eca
...
// New creates a new eca parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("eca"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python eca.py
