...
// This is a 100% exact Go translation of Python's skhron parser
package skhron
...
// New creates a new skhron parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("skhron"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python skhron.py
