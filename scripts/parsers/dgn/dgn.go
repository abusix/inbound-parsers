...
// This is a 100% exact Go translation of Python's dgn parser
package dgn
...
// New creates a new dgn parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("dgn"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python dgn.py
