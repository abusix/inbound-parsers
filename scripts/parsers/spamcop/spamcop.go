...
// This is a 100% exact Go translation of Python's spamcop parser
package spamcop
...
// New creates a new spamcop parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("spamcop"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python spamcop.py
