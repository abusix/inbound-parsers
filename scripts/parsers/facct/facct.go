...
// This is a 100% exact Go translation of Python's facct parser
package facct
...
// New creates a new facct parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("facct"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python facct.py
