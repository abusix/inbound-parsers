...
// This is a 100% exact Go translation of Python's ebs parser
package ebs
...
// New creates a new ebs parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("ebs"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python ebs.py
