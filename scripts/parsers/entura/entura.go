...
// This is a 100% exact Go translation of Python's entura parser
package entura
...
// New creates a new entura parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("entura"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python entura.py
