...
// This is a 100% exact Go translation of Python's eq_ee parser
package eq_ee
...
// New creates a new eq_ee parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("eq_ee"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python eq_ee.py
