...
// This is a 100% exact Go translation of Python's exemail parser
package exemail
...
// New creates a new exemail parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("exemail"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python exemail.py
