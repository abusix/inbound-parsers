...
// This is a 100% exact Go translation of Python's enfappdetex parser
package enfappdetex
...
// New creates a new enfappdetex parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("enfappdetex"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python enfappdetex.py
