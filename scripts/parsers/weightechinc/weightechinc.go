...
// This is a 100% exact Go translation of Python's weightechinc parser
...
// New creates a new weightechinc parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("weightechinc"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python weightechinc.py
