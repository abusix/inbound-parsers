...
// This is a 100% exact Go translation of Python's eyeonpiracy parser
package eyeonpiracy
...
// New creates a new eyeonpiracy parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("eyeonpiracy"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python eyeonpiracy.py
