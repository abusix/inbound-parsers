...
// This is a 100% exact Go translation of Python's ebrand parser
package ebrand
...
// New creates a new ebrand parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("ebrand"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python ebrand.py
