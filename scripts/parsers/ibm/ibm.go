...
// This is a 100% exact Go translation of Python's ibm parser
package ibm
...
// New creates a new ibm parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("ibm"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python ibm.py
