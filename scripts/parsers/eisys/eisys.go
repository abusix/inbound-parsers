...
// This is a 100% exact Go translation of Python's eisys parser
package eisys
...
// New creates a new eisys parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("eisys"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python eisys.py
