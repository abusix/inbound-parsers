...
// This is a 100% exact Go translation of Python's esp parser
package esp
...
// New creates a new esp parser instance
func New() *Parser {
	return &Parser{
		BaseParser: base.NewBaseParser("esp"),
	}
}

// Parse parses the email and returns events
func (p *Parser) Parse(serializedEmail *email.SerializedEmail) ([]*events.Event, error) {
	// TODO: Port logic from Python esp.py
